        ...
        return (
          <div key={category.date} className="space-y-2.5">
            ...
            {category.activities.length > 0 ? (
                ...
                {category.activities.map(activity => {
                  return (
                    <div key={activity.id} className="space-y-2.5">
                      <div className="px-4 py-2.5 bg-zinc-900 rounded-xl shadow-shape flex items-center gap-3 my-2">
              ...
              <p className="text-zinc-500 text-sm">Nenhuma atividade nesta data  </p>
            )}
          </div>
        )
      })}
